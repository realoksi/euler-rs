...
pub fn run() {
    ...
    println!("{}. {}", largest_palindrome_product::PROBLEM_ID, largest_palindrome_product::run());
    println!("{}. {}", smallest_multiple::PROBLEM_ID, smallest_multiple::run());
    println!("{}. {:?}", sum_square_difference::PROBLEM_ID, sum_square_difference::run());
}
